...
export default function App() {
  ...
  const buildLinkedInLink = () => {
    return `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(makeUrl())}`;
  };
  ...
  // LinkedIn receives the public result URL directly, so posts show the
  // GitHub Pages domain instead of the separate Open Graph preview service.
  // LinkedIn therefore uses the site's general preview rather than the
  // per-result card generated by that service.
