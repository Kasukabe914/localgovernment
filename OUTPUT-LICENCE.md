...
Except where third-party rights are identified below, the original text,
charts, figures, screenshots and other visual outputs of the Local Government
Amalgamator are licensed under the
[Creative Commons Attribution 4.0 International Licence](https://creativecommons.org/licenses/by/4.0/)
(CC BY 4.0).

Copyright © 2026 Mischewski Consulting Limited.
...
person or organisation reusing it, or the position for which it is reused.

## Boundaries

This licence covers the project's original editorial and visual output. It
does not re-license:
...
The source datasets retain their own copyright and licence terms. See
`DATA-LICENCE.md` for source-specific attribution and reuse information.
